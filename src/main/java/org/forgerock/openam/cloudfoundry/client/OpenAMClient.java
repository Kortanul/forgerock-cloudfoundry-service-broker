...
public class OpenAMClient {
     ...
     *
     * @param configuration
     * The {@link Configuration} for the client
     * @throws HttpApplicationException
     * If the client is unable to determine the configured SSOToken cookie name
     */
     ...
     *
     * @param username
     * The username to use for the client
     * @param password
     * The password to use for the client
     * @return
     * A {@link Promise} containing the {@link Response} from OpenAM
     */
